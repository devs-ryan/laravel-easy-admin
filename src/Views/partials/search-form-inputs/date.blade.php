<div class="form-group">
    ...
    <div class="input-group input-group-sm">
        <input class="form-control" type="date" id="{{ $index_column }}__from" name="{{ $index_column }}__from" value="{{ Request::get($index_column . '__from') ?? '' }}">
...
<div class="form-group">
    ...
    <div class="input-group input-group-sm">
        <input class="form-control form-control-sm" type="date" id="{{ $index_column }}__to" name="{{ $index_column }}__to" value="{{ Request::get($index_column . '__to') ?? '' }}">
