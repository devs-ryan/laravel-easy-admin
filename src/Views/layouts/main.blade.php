...
<head>
    ...
    <script src="{{ asset('raysirsharp/LaravelEasyAdmin/js/jquery-3.5.1.min.js') }}"></script>
    <script src="{{ asset('raysirsharp/LaravelEasyAdmin/js/laravel-easy-admin.min.js') }}"></script>
